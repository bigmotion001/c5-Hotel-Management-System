...
<div class="d-flex justify-content-between align-items-center">
    ...
    <div class="button">
        <a href="{{ route('add_gallery') }}" class="btn btn-warning"><span style="font-weight: bolder;">+ </span> Add New</a>
    </div>
</div>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->title}}</td>
                                    <td>
                                        <img style="width: 100px; height:100px; object-fit:cover" src="backend/assets/images/{{$data->image}}" alt="{{$data->title}}">
                                    </td>
