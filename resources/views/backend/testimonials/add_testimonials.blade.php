    ...
    <div class="row">
        ...
        <div class="col-md-12 ">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" action="{{route('save_testimonials')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="row col-md-12 col-12">
                                ...
                                <div class="mb-2 col-sm-12">
                                    ...
                                    <textarea name="testimony" id="testimony" cols="30" rows="3" class="form-control">{{ old('testimony') }}</textarea>
                                    @error('ttestimony')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary me-1">Add Testimonials</button>
                            </div>
                        </div>
                    </form>
                </div>
