...
@php
     $todayreservation = App\Models\Booking::orderBy('created_at', 'DESC')->get();
@endphp
    ...
    <div class="col-md-12 ">
        ...
        <div class="card">
            ...
            <div class="card-header with-border">
                <h3 class="card-title ">Active Reservation Request</h3>
                <a class="btn btn-info" href="{{ route('export.booking') }}">Export File</a>
            </div>
