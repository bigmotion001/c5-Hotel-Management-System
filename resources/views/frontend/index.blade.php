...
@section('content')
    <div class="hero full-height jarallax"
        data-jarallax-video="mp4:./{{ 'frontend/video/sunset.mp4' }},webm:./{{ 'frontend/video/sunset' }}.webm,ogv:./video/sunset.ogv"
        data-speed="0.2">
    ...
    <div class="marquee">
        <div class="track">
            <div class="content">&nbsp;Relax Enjoy Luxury Holiday Travel Discover Experience Relax Enjoy Luxury Holiday
                Travel Discover Experience Relax Enjoy Luxury Holiday Travel Discover Experience Relax Enjoy Luxury Holiday
                Travel Discover Experience</div>
        </div>
    </div>
    <!-- /marquee-->
